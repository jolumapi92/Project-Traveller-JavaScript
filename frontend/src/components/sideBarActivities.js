...
const EventActivities = () => {
    ...
    return ( 
        <div className="side-bar-activities">
            <h3 className="border-bottom border-warning border-4 title-header-activities-location">Activities</h3> 
            <p className="instructions-of-activities-event">These are all the activities you can choose from according to the location you selected.</p> 
            {loading && loading }
