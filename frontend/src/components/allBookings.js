...
const AllBookings = () => {
    ...
    return ( 
        <section className="p-5 d-flex align-items-center justify-content-center main-section-allbookings">
            ...
            { retrieve && <div className="display-info-journey"> <h1 className="border-3 header-journey-event-file">Journey</h1> { retrieve.data[0].activities.map( element => { return  <p className="activity-paraph">{ element.name }</p> } ) } <div className="d-flex justify-content-center align-items-center container-images-journey-popup">
